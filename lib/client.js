  ...
  function CrowdClient(settings) {
    ...
    this.user = {
      ...
      get: function get(username) {
        ...
        return _this.request('GET', '/user?username=' + username + (withAttributes ? '&expand=attributes' : '')).then(_modelsUser2['default'].fromCrowd);
      },
      ...
      update: function update(username, user) {
        ...
        return _this.request('PUT', '/user?username=' + username, user.toCrowd()).then(function () {
      ...
      attributes: {
        ...
        list: function list(username) {
          return _this.request('GET', '/user/attribute?username=' + username).then(function (res) {
            return _modelsAttributes2['default'].fromCrowd(res.attributes);
          });
        },
        ...
        set: function set(username, attributes) {
          try {
            return _this.request('POST', '/user/attribute?username=' + username, {
    ...
    this.group = {
      ...
      attributes: {
        ...
        set: function set(groupname, attributes) {
          try {
            return _this.request('POST', '/group/attribute?groupname=' + groupname, {
              attributes: attributes.toCrowd()
            }).then(function () {
